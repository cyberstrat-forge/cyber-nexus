...
| `intelligence_id` | string | 条件 | 情报卡片 ID（成功且有情报时必需） |
...
| `null` | 需要人工复核 | 加入 `review.pending` 队列，等待审核 |
...
- threat-20260313-001
- vendor-20260313-002
- industry-20260313-003
```

## pending_id 格式（待审核项）

```
pending-{domain}-{YYYYMMDD}-{seq}

例如：
- pending-threat-20260313-001
- pending-emerging-20260313-002
```
