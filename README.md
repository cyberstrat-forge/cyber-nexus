...
[![Version](https://img.shields.io/badge/version-1.0.16-blue.svg)](https://github.com/cyberstrat-forge/cyber-nexus/releases/tag/v1.0.16)
...
| 插件 | 版本 | 状态 | 描述 |
|------|------|------|------|
| [market-radar](./plugins/market-radar) | 1.3.2 | ✅ 可用 | 从文档中提取战略情报，生成情报卡片和主题分析报告 |
