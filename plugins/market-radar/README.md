...
[![Version](https://img.shields.io/badge/version-1.3.1-blue.svg)](https://github.com/cyberstrat-forge/cyber-nexus/releases/tag/v1.3.1)
...
│  ┌──────────┐    ┌──────────────┐    ┌────────────────────┐      │
│  │ 源文档    │───→│ 情报蒸馏      │───→│ 主题分析            │      │
│  │ PDF/DOCX │    │ intel-distill│    │ thematic-analysis  │      │
│  │ MD/TXT   │    │              │    │                    │      │
│  └──────────┘    └──────┬───────┘    └─────────┬──────────┘      │
│                         │                      │                 │
│                         ▼                      ▼                 │
