...
**Obsidian 链接格式**：
- 格式：`[[文件名|显示标题]]`，用户点击标题即可跳转
- 从 `card_path` 提取文件名：`Vendor-Intelligence/2026/04/20260406-crowdstrike.md` → `[[20260406-crowdstrike|CrowdStrike Falcon XDR 新增 AI 模块]]`
...
- [[20260406-crowdstrike-falcon-xdr|CrowdStrike Falcon XDR 新增 AI 威胁检测模块]] — 利用 LLM 提升未知威胁识别能力，XDR 领域重要创新
- [[20260406-crowdstrike-funding|CrowdStrike 获 2 亿美元战略投资]] — 资金将用于 AI 安全研发，加速产品线扩展
...
- [[20260406-litellm-supply-chain|LiteLLM 供应链攻击波及 Mercor]] — AI 生态供应链首遭勒索组织系统性利用，4TB 数据被 Lapsus$ 窃取
- [[20260406-opensource-malware|开源生态恶意软件通报激增 13.6 倍]] — npm、PyPI 成为攻击重点，供应链攻击进入"工业化"阶段

### Policy-Regulation（政策法规）

欧盟发布 AI 安全治理指南，对高风险 AI 系统提出强制性安全评估要求。指南涉及 **透明度、可解释性、人类监督** 三大核心原则，预计 2026 年底正式生效。跨国企业需提前调整 AI 产品合规策略。

- [[20260406-eu-ai-governance|欧盟发布 AI 安全治理指南]] — 对高风险 AI 系统提出强制性要求，影响 AI 安全产品设计
...
**关联情报**：[[20260406-crowdstrike-falcon-xdr|CrowdStrike Falcon XDR 新增 AI 模块]]、[[20260406-crowdstrike-funding|CrowdStrike 获战略投资]]
...
**关联情报**：[[20260406-litellm-supply-chain|LiteLLM 供应链攻击]]、[[20260406-opensource-malware|开源恶意软件激增]]
...
**关联情报**：[[20260406-eu-ai-governance|欧盟 AI 安全治理指南]]
